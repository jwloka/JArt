...
public class TestBitwiseXorExpression extends TestBase
{

    public TestBitwiseXorExpression(String name)
    {
        super(name);
    }

    public void testBitwiseXorExpression1() throws ANTLRException
    {
        setupParser("1 ^ 2");
    ...
    public void testBitwiseXorExpression2() throws ANTLRException
    {
    ...
    public void testBitwiseXorExpression3() throws ANTLRException
    {
    ...
    public void testBitwiseXorExpression4() throws ANTLRException
    {
    ...
    public void testBitwiseXorExpression5() throws ANTLRException
    {
