...
public class TestBitwiseAndExpression extends TestBase
{

    public TestBitwiseAndExpression(String name)
    {
        super(name);
    }

    public void testBitwiseAndExpression1() throws ANTLRException
    {
        setupParser("1 & 2");
    ...
    public void testBitwiseAndExpression2() throws ANTLRException
    {
    ...
    public void testBitwiseAndExpression3() throws ANTLRException
    {
    ...
    public void testBitwiseAndExpression4() throws ANTLRException
    {
    ...
    public void testBitwiseAndExpression5() throws ANTLRException
    {
